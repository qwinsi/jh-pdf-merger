...
class MainWindow(QMainWindow):
    ...
    def _initUI(self):
        ...
        self._both_file_name_and_section_radio = QCheckBox(translate("MainWindow",
                                                                     "from file names and bookmarks in each file"))
        ...
        self._only_file_name_radio = QCheckBox(translate("MainWindow", "from only file names"))
    ...
    def openFileDialog(self):
        ...
        filter_prompt = translate("MainWindow", "PDF Files (*.pdf)")
    ...
    def mergePdfs(self):
        ...
        if QtCore.QFile.exists(output_path):
            ok = self.request_confirmation(f"A file named {output_path} already exists. Continue to overwrite?",
                                           translate("MainWindow", "Additional Confirmation"))
            if not ok:
                return
